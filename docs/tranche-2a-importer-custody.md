...
4. **D9.3 — next separately reviewed step, local custody and recovery:** restricted CAS adapter, no-replace durability, copy-aware access, operation journal, lock, crash recovery and conservative orphan reconciliation.
