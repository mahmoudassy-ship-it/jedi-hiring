...
Status: **approved at commit `ee3ccd777849c7ffcad1efe5d5d9170c15171a65`; not authorized for real evidence**. The approved version-1 manifest contract and empty migration-005 schema are unchanged. D9.1 and D9.2 remain approved only as synthetic, unactivated boundaries. D9.3.0 remains an approved design-only contract freeze, and the synthetic, unactivated [D9.3.1 primary-custody implementation](d9-3-1-primary-custody-runtime.md) is approved at commit `d960a03f4b8ac8a78d3f6b40ba909eb24b5f3442`. None of these milestones authorizes credentials, real bootstrap, evidence acquisition or import, canonical promotion, operational custody or recovery, legal verification, publication, API, frontend, or production use. Accepted evidence projection and physical custody remain distinct from verified legal authority. D9.4 restriction, security, clearance, and deletion controls are next.
...
4. **D9.3.0 — approved design-only contract freeze:** separately versioned primary-receipt, adapter-v2, journal-v2 and conservative crash-state classification contracts only; no runtime or recovery action. **D9.3.1** has an [approved synthetic, unactivated implementation](d9-3-1-primary-custody-runtime.md) at commit `d960a03f4b8ac8a78d3f6b40ba909eb24b5f3442`; it does not enable operational custody, real evidence, legal verification, or recovery action.
5. **D9.4.0 — approved design-only restriction/deletion contract freeze:** append-only restriction, hold, revocation, tombstone, primary-deletion, receipt, propagation, and D9.5 coordination contracts. **D9.4.1** is separately approved only as a synthetic, unactivated implementation; neither milestone authorizes operational deletion.
