...
Decision 9 and D9.0 approvals fix design contracts only. No importer, bootstrap ceremony, credential, runtime component, custody object, principal creation, or evidence import is authorized yet. Any D9.3 durability-receipt extension requires its own version, review, and approval.
