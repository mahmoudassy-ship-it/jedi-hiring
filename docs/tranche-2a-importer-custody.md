...
5. **D9.4.0 — design-only restriction/deletion contract proposal awaiting approval:** append-only restriction, hold, revocation, tombstone, primary-deletion, receipt, propagation, and D9.5 coordination contracts. **D9.4.1** remains a separately reviewed synthetic implementation; neither milestone authorizes operational deletion.
