...
4. **D9.3.0 — proposed contract freeze, awaiting approval:** separately versioned primary-receipt, adapter-v2, journal-v2 and conservative crash-state classification contracts only; no runtime or recovery action. **D9.3.1** will separately implement primary custody and journal behavior after approval.
