...
- The approved D9.0.1 handle contracts remain unchanged. This module consumes already opened, synthetic descriptor/capability seams; D9.1 remains responsible for control-plane selection and delivery, while D9.3 remains responsible for primary custody, promotion coordination, crash-state classification, and durable audit; D9.5 remains responsible for backups and restore. The proposed D9.3.0 contract authorizes no recovery action.
...
The approved D9.2 implementation remains unactivated and synthetic. Its approval neither converts accepted evidence into verified legal authority nor authorizes any operational effect. D9.3.0 must first receive approval, after which D9.3.1 must separately implement primary custody durability and conservative crash-state classification; D9.4 and D9.5 retain restriction and backup responsibilities before this work can participate in a real evidence path.
