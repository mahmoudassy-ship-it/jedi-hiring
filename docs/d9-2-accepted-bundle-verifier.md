...
- The approved D9.0.1 handle contracts remain unchanged. This module consumes already opened, synthetic descriptor/capability seams; D9.1 remains responsible for control-plane selection and delivery, while D9.3 remains responsible for primary custody, promotion coordination, crash-state classification, and durable audit; D9.5 remains responsible for backups and restore. The approved design-only D9.3.0 contract authorizes no recovery action or runtime use.
...
- From-zero reconstruction here means a disposable synthetic recovery database rebuilt from privately copied, hash-verified migrations and ordered accepted manifests while all required bytes remain available. Its comparison target must be an in-process branded accepted-database verification, not a caller-supplied digest. It makes no D9.3 primary-custody durability, D9.4 restriction, or D9.5 backup/deletion-aware restore claim.
...
- D9.3.1 custody prepare/finalize coordination, operational candidate promotion, journal durability, and conservative crash-state classification; D9.4 restriction/tombstone controls; and D9.5 backup/restore and deletion-aware reconstruction;
...
The approved D9.2 implementation remains unactivated and synthetic. Its approval neither converts accepted evidence into verified legal authority nor authorizes any operational effect. The design-only D9.3.0 contract freeze is approved externally without activation, and the separate D9.3.1 synthetic implementation is approved at commit `d960a03f4b8ac8a78d3f6b40ba909eb24b5f3442`. D9.4 and D9.5 retain restriction and backup responsibilities before this work can participate in a real evidence path.
