...
- Approve the proposed D9.3.0 contract extension, then separately implement and review D9.3.1 primary custody, journal durability, and conservative crash-state classification. Only afterward may the approved D9.2 seams be integrated with the protected D9.1 runtime and trusted authenticated-invoker mapping without widening either boundary. D9.4 still owns restriction/tombstone policy and D9.5 still owns backup/restore; D9.3.0 authorizes no recovery action.
