...
Current D9.3.1 note: the [synthetic, unactivated primary-custody implementation](d9-3-1-primary-custody-runtime.md) is approved at commit `d960a03f4b8ac8a78d3f6b40ba909eb24b5f3442`. Approval does not authorize operational custody, real evidence, evidence acceptance, or legal verification. D9.4 restriction, security, clearance, and deletion controls are next.
