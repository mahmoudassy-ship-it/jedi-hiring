...
- Implement and separately review D9.3 local custody and recovery, then integrate the approved D9.2 manifest/preflight/plan/writer/verifier seams with the protected D9.1 runtime and trusted authenticated-invoker mapping without widening either boundary.
