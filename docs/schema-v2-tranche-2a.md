...
- Preserve the approved, synthetic D9.3.1 primary-custody boundary without activating it. Next, separately design, implement, and review D9.4 restriction, security, clearance, tombstone, and deletion controls. D9.5 still owns backup/restore; neither D9.3.0 nor D9.3.1 authorizes recovery action, real evidence, or runtime use.
