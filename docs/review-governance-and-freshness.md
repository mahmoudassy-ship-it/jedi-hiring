...
Current D9.5 note: the [D9.5.0 backup, restore, and deletion-aware reconstruction contract](d9-5-0-backup-restore-contracts.md) revision `1.0.0` is approved at reviewed commit `120b1ef1436483349bd8fc2beb78fe851de6e1f3` as a design-only contract freeze. It preserves all approved D9.0.1–D9.4.1 boundaries, selects recovery-resolver v1.3 while retaining v1.2 as immutable historical/read-only compatibility, and defines no operational runtime. Its manifests, durability receipts, restore records, deletion-aware assessments, journal receipts, and drills are technical evidence only. They establish no evidence acceptance, officiality, legal identity or status, legal effect, legal verification, publication eligibility, compliance, complete erasure, or operational permission.
