...
Current D9.5 note: the [D9.5.0 backup, restore, and deletion-aware reconstruction contract](d9-5-0-backup-restore-contracts.md) revision `1.0.0` is approved at reviewed commit `120b1ef1436483349bd8fc2beb78fe851de6e1f3` as a design-only contract freeze. The [D9.5.1 synthetic implementation](d9-5-1-backup-restore-runtime.md), initially implemented at `5ebe7d6` and hardened at approved commit `7cc08a0a3040e4e77ca44ac9a083ad9fdb14b6fe`, preserves that boundary, selects recovery-resolver v1.3 while retaining v1.2 as immutable historical/read-only compatibility, and is approved only as an unactivated runtime using generated identities and disposable storage. Its manifests, durability evidence, restore records, deletion-aware assessments, journal receipts, and drills are technical evidence only. They establish no evidence acceptance, officiality, legal identity or status, legal effect, legal verification, publication eligibility, compliance, complete erasure, recovery authority, or operational permission.

Status: approved sixth architectural requirement. Separately numbered implementation Decision 6 approves the boundary between Tranche 2A source-evidence quarantine and Tranche 2B source-backed authority drafting, Decision 7 approves the hybrid pilot evidence-custody/import contract, and Decision 8 approves six logical Tranche 2A evidence boundaries; the architectural-requirement and implementation-decision numbering series are distinct. The exact 2A schema and manifest contract were later approved, and migration `005_tranche_2a_source_quarantine.sql` implements the empty nine-table physical schema. [Decision 9](tranche-2a-importer-custody.md) approves the fixed-function architecture. Frozen and approved synthetic boundaries through D9.4.1 remain unchanged. D9.5.0 revision `1.0.0` is approved only as the design-only technical contract root at commit `120b1ef1436483349bd8fc2beb78fe851de6e1f3`; D9.5.1 is approved at hardened implementation commit `7cc08a0a3040e4e77ca44ac9a083ad9fdb14b6fe` only as a synthetic, unactivated runtime using disposable roots and generated identities. Active restrictions withhold restoration fail-closed because operational restricted-capability enforcement remains outside D9.5.1. Approval creates no production activation, operational credential, real backup or restoration, recovery authority, complete-erasure claim, evidence acceptance, legal verification, publication, Atlas mutation, API, frontend, or public surface. The [first controlled evidence-pilot readiness proposal](first-evidence-pilot-readiness.md) at reviewed commit `879453b301a5ffdadb2aee832023c8e6443785b0` is approved only as the planning and governance baseline. Its operational verdict remains **NO-GO**, and every DR decision remains pending until a separately attributable, scoped and evidenced human decision record exists. The approval satisfies no human gate and authorizes no source, profile, identity, credential, RPO/RTO, retention, backup medium, recovery authority, activation, bootstrap, collection, import, publication, Atlas mutation or public surface.
...
The [single-operator research track](single-operator-research-track.md) is deliberately outside these governance states. `metadata_checked_single_researcher` is not independent source verification; `awaiting_independent_review` is not a review event. Labelled automation cannot advance either state. Research manifests and their disposable SQLite projection cannot satisfy a gate, create accepted evidence, support publication, or establish freshness. A later crosswalk must create new D9 evidence and authority records under their own provenance and review history; it cannot promote a research row in place.
...
The approved planning baseline does not itself begin operationalization. The next step is human resolution of the pending decisions in the [first evidence-pilot readiness plan](first-evidence-pilot-readiness.md): protected real identities and bindings, exact operational builds and IPC, trusted time, primary and independent backup storage, incident authority, explicit RPO/RTO and stage-specific authorization. Until every applicable blocking gate has a separately attributable, scoped and evidenced human decision and its required technical proof, the decision remains NO-GO. Even a later successful bootstrap and one-document quarantine would remain technical evidence capture only; Tranche 2B authority drafting and version-specific human legal review remain later work.
...
- Preserve the approved frozen and synthetic boundaries through D9.4.1. The approved design-only D9.5.0 revision `1.0.0` contract root defines, but does not implement or activate, exact-byte backup evidence, semantically matched D9.3 artifact references, explicit D9.5 source-copy receipts, authenticated three-human approval submissions, deletion-aware reconstruction, reverse-complete current-control mapping, fresh protected retention-head attestations at planning and promotion, independently verified atomic promotion, deterministic drills, and closed crash classification. Its fixtures and storage descriptions remain synthetic; protected clocks and stores, authenticated IPC, operational identities and credentials, service isolation, backup media, external rollback resistance, tested atomic promotion, incident procedures, explicit operational RPO/RTO values, and separately approved recovery authority remain prerequisites.
- Before any operational restore, implement and separately approve the D9.5.0 rule that a tombstone or hash cannot recreate deleted bytes: current D9.4 controls must be reconstructed and applied before exposure, and unavailable bytes must fail closed.
