...
- Preserve the approved synthetic, unactivated [D9.3.1 primary-custody implementation](d9-3-1-primary-custody-runtime.md) against the approved [D9.3.0 custody-durability contract freeze](d9-3-0-custody-durability-contracts.md). It does not alter D9.0.1, execute recovery, accept real evidence, or authorize runtime use. The next milestone is separately reviewed D9.4 restriction, security, clearance, tombstone, and deletion controls. The remaining operational Decision 9 sequence still requires real ceremony authorization, authenticated-principal activation, full D9.1/D9.2/D9.3 process integration, D9.5 backup/restore tests, and durable operational audit before accepting any evidence.
