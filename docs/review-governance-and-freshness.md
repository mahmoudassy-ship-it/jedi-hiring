...
- Complete the separately reviewed [Decision 9](tranche-2a-importer-custody.md) implementation sequence, beginning with D9.0—the contract freeze—and implement and security-review the fixed-function importer, first-bundle ceremony, authenticated-principal bindings, non-SQL write isolation, local custody adapter, clearance procedure, retention/tombstone controls, backup/restore tests and durable operational audit before accepting any evidence.
