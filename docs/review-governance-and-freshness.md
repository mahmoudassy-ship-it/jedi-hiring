...
The next proposed step is not a new legal-data or synthetic-contract tranche. It is the separately reviewed operationalization described in the [first evidence-pilot readiness plan](first-evidence-pilot-readiness.md): protected real identities and bindings, exact operational builds and IPC, trusted time, primary and independent backup storage, incident authority, explicit RPO/RTO and a stage-specific authorization process. Until all blocking gates are resolved, the decision is NO-GO. Even a successful bootstrap and one-document quarantine would remain technical evidence capture only; Tranche 2B authority drafting and version-specific human legal review remain later work.
