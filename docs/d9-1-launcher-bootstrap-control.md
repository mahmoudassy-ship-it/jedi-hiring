...
Full operation-journal recovery, candidate promotion, custody durability, backup durability and operational accepted-state reconstruction remain outside D9.1. The D9.2 candidate covers only synthetic disposable reconstruction while every original byte remains available; D9.3 retains the durability and deletion-aware recovery boundary. The D9.1 control ledger must not be presented as those later guarantees.
...
- approval and protected-runtime integration of the synthetic D9.2 verifier candidate;
