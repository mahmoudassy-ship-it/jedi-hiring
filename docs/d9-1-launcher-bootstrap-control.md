...
Full operation-journal recovery, candidate promotion, custody durability, backup durability and accepted-state reconstruction remain in D9.2/D9.3. The D9.1 control ledger must not be presented as those later guarantees.
...
- the D9.2 importer/writer/verifier projection implementation;
