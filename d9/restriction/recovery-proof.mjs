...
const reconstructions = new WeakSet()

export function registerD941Reconstruction(state) { reconstructions.add(state); return state }

export function issueD941RecoveryClassificationProof(record, reconstruction, broker) {
  if (!reconstructions.has(reconstruction)) failD941('D941_RECOVERY_RECONSTRUCTION_UNTRUSTED', 'classification proof requires the fixed reconstruction capability')
